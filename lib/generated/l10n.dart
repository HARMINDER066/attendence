...
class S {
  ...
  String get search_for_markets_or_products {
    return Intl.message(
      'Search for markets or products or categories',
  ...
  String get should_be_a_valid_mobile {
    return Intl.message(
      'Should be a valid mobile number',
      name: 'should_be_a_valid_mobile',
      desc: '',
      args: [],
    );
  }
  ...
  /// `You must login to access this Notifications`
  ...
  String get available_quantities {
    return Intl.message(
  ...
  String get no_active_membership {
    return Intl.message(
  ...
  String get select_delivery_or_pickup {
    return Intl.message(
      'Please select Delivery Or Pickup.',
      name: 'select_delivery_or_pickup',
      desc: '',
      args: [],
    );
  }
  ...
  String get youDontHaveAnyFavProd {
    return Intl.message(
      'You don\'t  have any favourite product',
      name: 'youDontHaveAnyFavProd',
      desc: '',
      args: [],
    );
  }
  ...
  /// `You don't  have any favourite product`
  String get youDontHaveAnyItemInCategory {
    return Intl.message(
      'You don\'t  have any products in this category.',
      name: 'youDontHaveAnyItemInCategory',
      desc: '',
      args: [],
    );
  }
  ...
  String get select_delivery_pickup {
    return Intl.message(
      'Select Pickup or Delivery methods and get the product from the market',
  ...
  String get hint_tag_location {
    return Intl.message(
      'e.g. Home, Work, Hotel, Other',
      name: 'hint_tag_location',
      desc: '',
      args: [],
    );
  }

  String get tag_location {
    return Intl.message(
      'Tag this location',
      name: 'tag_location',
      desc: '',
  ...
  String get floor_validation {
    return Intl.message(
      'Enter valid floor information.',
      name: 'floor_validation',
      desc: '',
      args: [],
    );
  }
