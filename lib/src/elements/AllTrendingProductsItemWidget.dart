...
class AllTrendingProductsItemWidget extends StatefulWidget {
  final double marginLeft;
  final Product product;
  final String heroTag;

  AllTrendingProductsItemWidget({Key key, this.heroTag, this.marginLeft, this.product}) : super(key: key);

  @override
  AllTrendingProductsItemWidgetState createState() => AllTrendingProductsItemWidgetState();
}

class AllTrendingProductsItemWidgetState extends StateMVC<AllTrendingProductsItemWidget> {
  ...
  AllTrendingProductsItemWidgetState() : super(ProductController()) {
    _con = controller;
  }
